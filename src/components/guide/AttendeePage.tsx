...
const VENUE: Record<string, { label: string; short: string; accent: string; dim: string }> = {
  ...
  'll-a':       { label: 'Sound',      short: 'SOUND',      accent: '#1E3A8A', dim: '#DBEAFE' },
  'll-b':       { label: 'Marina',     short: 'MARINA',     accent: '#14532D', dim: '#DCFCE7' },
};
    ...
    <div className="guide-root">
      ...
      <div className="guide-scroll">
        ...
        <div className="guide-footer">
          <img src="/canvas-logo-light.webp" alt="Canvas by Franklin Templeton" className="guide-footer-logo" />
